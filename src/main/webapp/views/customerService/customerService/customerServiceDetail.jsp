	...
	<main class="main">
        ...
        <section class="enroll-section">
            <form action="/customerServiceBoard/enroll.do" method="POST">
                ...
                <div class="notice-title">${result.boardTitle}</div>

                <div class="notice-writer">${result.userName} ${result.boardIndate}</div>
                
                <div class="notice-content">${result.boardContents}</div>
