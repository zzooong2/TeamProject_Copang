...
<body>
    ...
    <main class="main">
                ...
                <div id="Field" class="section">
                    ...
                    <form class="field_page" id="fieldForm">
                        <div class="form_group">
                            ...
                            <label><input type="checkbox" name="businessField" value="IT.프로그래밍" disabled> IT.프로그래밍</label>
                            <label><input type="checkbox" name="businessField" value="영상 및 사진" disabled> 영상 및 사진</label>
                            <label><input type="checkbox" name="businessField" value="디자인" disabled> 디자인</label><br>
        ...
        <div class="reasons">
            <p>코팡을 떠나시는 이류를 선택해주세요.</p>
            <label><input type="checkbox" name="reason" value="no_service"> 서비스 이용이 불편해요</label><br>
            <label><input type="checkbox" name="reason" value="low_quality"> 서비스 퀄리티가 낮아요</label><br>
            <label><input type="checkbox" name="reason" value="bad_users"> 비매너 회원을 만났어요</label><br>
            <label><input type="checkbox" name="reason" value="frequent_errors"> 잦은 오류가 발생해요</label><br>
            <label><input type="checkbox" name="reason" value="find_alternative"> 대체할 만한 서비스를 찾았어요</label><br>
            <label><input type="checkbox" name="reason" value="benefits_issue"> 쿠폰 · 적립금 등 혜택이 적어요</label><br>
        </div>
        ...
        <div class="additional_info">
            ...
            <ul>
                ...
                <li>탈퇴 후 회원님의 정보는 전자상거래 소비자보호법에 의거한 크몽 개인정보처리방침에 따라 관리됩니다.</li>
                <li>현재 보유 중인 쿠폰 및 무상지급된 크몽 캐시와 비즈머니는 모두 자동 소멸되며, 탈퇴 후 재가입하더라도 이미 소멸되었기 때문에 양도되지 않습니다.</li>
                <li>구매후기 및 답글은 탈퇴 시 자동 삭제되지 않습니다. 탈퇴 후에는 계정 정보가 삭제되어 본인 확인이 불가하므로, 탈퇴 신청 전에 게시글 삭제를 요청해 주시기 바랍니다.</li>
                <li>충전 캐시, 충전 비즈머니 또는 수익금이 있을 경우, 캐시 환불, 비즈머니 환불 및 수익금 출금을 통해 정산이 완료된 이후 탈퇴를 신청하셔야 합니다.</li>
                <li>* 무상으로 지급된 크몽캐시는 탈퇴와 함께 자동 소멸됩니다.</li>
            </ul>
        </div>
