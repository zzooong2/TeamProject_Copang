    ...
    <div id="main" class="register-page">
        <div class="register-container">
            ...
            <form action="register" method="post">
                ...
                <div id="business" id="business_field">
                    ...
                    <label for="business_marketing"><input type="checkbox" id="business_marketing" class="business-checkbox" name="business_field" value="Marketing"> 마케팅</label>
                    <label for="business_education"><input type="checkbox" id="business_education" class="business-checkbox" name="business_field" value="Education"> 교육</label>
                </div>
				<br>                
			<div class="agree_container">
                ...
                <button type="submit" onclick="registerClick()">회원가입</button> <br>
            </form>
        </div>
    </div>
    <hr>
